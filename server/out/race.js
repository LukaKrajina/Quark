...
exports.mhp = mhp;
exports.entanglementClosure = entanglementClosure;
exports.detectRaces = detectRaces;
exports.detectQuantumRaces = detectQuantumRaces;
// ---------------------------------------------------------------------------
// MHP 谓词
// ---------------------------------------------------------------------------
 ...
 */
function entanglementClosure(pairs) {
 ...
 */
function detectQuantumRaces(accesses) {
    const races = [];
    for (let i = 0; i < accesses.length; i++) {
        for (let j = i + 1; j < accesses.length; j++) {
            const a = accesses[i], b = accesses[j];
            ...
            const overlap = intersects(a.destructiveQubits, b.digest.qubits) ||
