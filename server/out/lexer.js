...
class Lexer {
    ...
    getNextToken() {
        ...
        if (char === '@') {
            this.advance();
            return { type: TokenType.At, value: '@', line: startLine, column: startCol, length: 1 };
        }
        if (char === '.') {
            this.advance();
        ...
        if (char === '<') {
            ...
            if (this.currentChar() === '<') {
                this.advance();
                return { type: TokenType.ShiftLeft, value: '<<', line: startLine, column: startCol, length: 2 };
            }
        ...
        if (char === '%') {
            this.advance();
            return { type: TokenType.Percent, value: '%', line: startLine, column: startCol, length: 1 };
        }
        if (char === '&') {
            this.advance();
            if (this.currentChar() === '&') {
        ...
        if (char === '|') {
            ...
            return { type: TokenType.Pipe, value: '|', line: startLine, column: startCol, length: 1 };
        }
        if (char === '^') {
            this.advance();
            return { type: TokenType.Caret, value: '^', line: startLine, column: startCol, length: 1 };
        }
        if (char === '~') {
            this.advance();
            return { type: TokenType.Tilde, value: '~', line: startLine, column: startCol, length: 1 };
        }
        if (char === '>') {
            this.advance();
            if (this.currentChar() === '=') {
            ...
            if (this.currentChar() === '>') {
                this.advance();
                return { type: TokenType.ShiftRight, value: '>>', line: startLine, column: startCol, length: 2 };
            }
        ...
        if (/[\p{L}_]/u.test(char)) {
            ...
            const keywords = [
                ...
                // 指针型入口与堆释放（已开放语言绑定，见 semantic.ts / ir.ts）
