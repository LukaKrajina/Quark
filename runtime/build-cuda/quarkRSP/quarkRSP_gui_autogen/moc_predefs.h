...
#define __CUDA_API_VER_MAJOR__ 13
...
#define __device_builtin_texture_type__ __location__(device_builtin_texture_type)
...
#define __nv_pure__ __location__(nv_pure)
#define __SIZE_T 
...
#define __glibcxx_assert(cond) do { if (__builtin_expect(!bool(cond), false)) _GLIBCXX_ASSERT_FAIL(cond); } while (false)
...
#define QUARKRSP_SHADER_DIR "/run/media/lukakarajina/0b30dc8e-6c51-4d74-a656-601561091d59/Quark/runtime/build-cuda/quarkRSP/shaders"
...
#define __CUDACC_VER_BUILD__ 73
...
#define _GLIBCXX_ITER_MOVE(__it) std::iter_value_t<decltype(__it)>(std::ranges::iter_move(__it))
...
#define __tile_global__ __location__(tile_global)
...
#define __CLZ_PARAMETER_TYPE int
...
#define __inline_hint__ __attribute__((nv_inline_hint))
...
#define __block_size__(...) __attribute__((block_size(__VA_ARGS__)))
...
#define __device_builtin_surface_type__ __location__(device_builtin_surface_type)
...
#define __NV_SILENCE_HOST_DEPRECATION_END _Pragma("GCC diagnostic pop")
...
#define __tile__ __location__(tile)
...
#define __tile_builtin__ __location__(tile_builtin)
...
#define __CLZLL_PARAMETER_TYPE long long int
...
#define __GNUG__ 16
#define __local_maxnreg__(a) __attribute__((local_maxnreg(a)))
#define _GLIBCXX_HAVE___CXA_THREAD_ATEXIT_IMPL 1
#define __DECL_SIMD_log2p1f 
#define __SIZEOF_SIZE_T__ 8
#define __GLIBCXX__ 20260810
#define _WCHAR_T 
...
#define __maxnreg__(a) __attribute__((maxnreg(a)))
...
#define __NV_SILENCE_DEPRECATION_BEGIN _Pragma("nv_diagnostic push") _Pragma("nv_diag_suppress 20199") _Pragma("nv_diag_suppress 1444") __NV_SILENCE_HOST_DEPRECATION_BEGIN
...
#define __NV_SILENCE_DEPRECATION_END __NV_SILENCE_HOST_DEPRECATION_END _Pragma("nv_diagnostic pop")
...
#define CUDA_DOUBLE_MATH_FUNCTIONS 1
...
#define __NV_SILENCE_HOST_DEPRECATION_BEGIN _Pragma("GCC diagnostic push") _Pragma("GCC diagnostic ignored \"-Wdeprecated-declarations\"")
