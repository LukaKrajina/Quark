...
void quarkrsp::gui::QVulkanViewport::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->dragRotated((*reinterpret_cast<std::add_pointer_t<float>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<float>>(_a[2]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (QVulkanViewport::*)(float , float )>(_a, &QVulkanViewport::dragRotated, 0))
            return;
    }
}
...
// SIGNAL 0
void quarkrsp::gui::QVulkanViewport::dragRotated(float _t1, float _t2)
{
