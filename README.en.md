...
│       ├── numqk/             Numerical tensor library Numqk (Tensor / Autograd)
...
| Control & RL | `include/control/` | Quantum RL agent + end-to-end training pipeline + real physics environment + consciousness control + qbNs bridge |
